const fs = require('fs');
let content = fs.readFileSync('src/components/financial/ReceiveReceiptModal.tsx', 'utf-8');
...
fs.writeFileSync('src/components/financial/ReceiveReceiptModal.tsx', content);
