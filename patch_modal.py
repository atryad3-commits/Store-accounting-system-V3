...
# 2. Update history loop
target_history = """                prodHistory.push({
                   type: inv.type, 
...
replacement_history = """                let qty = Number(item.quantity) || 0;
...
if target_history in content:
    ...
    print("Could not find target_history")
...
if target_tabs in content:
    ...
    print("Could not find target_tabs")
...
if target_table in content:
    ...
    print("Could not find target_table")
