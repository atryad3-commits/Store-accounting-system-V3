...
export default function App() {
  ...
  const [personIOAction, setPersonIOAction] = useState<"import" | "export">(
    "export",
  );
          ...
          >
            ...
            <main className="flex-1 overflow-y-auto min-h-0 p-4 md:p-8 bg-slate-50/50 print:overflow-visible print:bg-white print:p-0">
              ...
              >
                {activeTab === "products" ? (
                  ...
                  <WarehouseManager showNotification={showNotification} />
            ...
            <AnimatePresence>
              ...
              {printingBarcodeProduct && (
                <div key="printingBarcodeProduct-modal"
                  className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm print:bg-white print:p-0 print:absolute print:z-auto print:block"
                  dir="rtl"
                >
                  <motion.div
                    initial={{ opacity: 0, scale: 0.95 }}
                  ...
                  >
                    ...
                    <div className="p-8 print:p-0 flex flex-col items-center justify-center min-h-[250px] print:min-h-0 text-center mx-auto print:mx-0">
                      <div className="border border-gray-100 p-6 rounded-2xl shadow-sm text-center w-full max-w-xs mx-auto print:border-none print:shadow-none bg-white print:m-0 print:p-1 print:max-w-[58mm] flex flex-col justify-center items-center">
                        <div className="font-extrabold text-gray-900 text-lg mb-2 truncate px-2 print:text-[12px] print:mb-1 print:leading-tight">
                        ...
                        <div className="flex justify-center my-2 text-center items-center overflow-hidden w-full print:my-0 scale-100 print:scale-[0.80] origin-top">
                          ...
                          printingBarcodeProduct.barcode.length > 0 ? (
                            ...
                            <div className="py-8 text-gray-400 text-sm font-bold bg-gray-50 rounded-xl w-full border border-gray-100 print:hidden">
                              بدون کد/بارکد
                            </div>
                          )}
                        </div>
