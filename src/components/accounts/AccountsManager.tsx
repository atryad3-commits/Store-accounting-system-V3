                          ...
                          <tbody className="divide-y divide-gray-50">
                            {(accounts || []).map((acc, index) => (
                              ...
                              >
                                ...
                                <td
                                  className="py-4 px-6 text-sm font-mono text-left"
                                  dir="ltr"
                                >
                                  {acc.accountNumber || "-"}
                                </td>
                                ...
                                <td
                                  className="py-4 px-6 text-sm font-semibold text-indigo-600 font-mono text-left"
                                  dir="ltr"
                                >
                                ...
                                <td className="py-4 px-6 text-center">
                                  <div className="flex items-center justify-center gap-2">
                                    ...
                                    <button
                                      onClick={() =>
                                        confirmAction(
  "آیا از حذف این حساب بانکی اطمینان دارید؟",
  () => handleDeleteAccount(acc.id),
  <div className="flex flex-col gap-2">
    <div><strong>نام حساب:</strong> {acc.title || acc.bankName}</div>
    {acc.bankName && <div><strong>بانک:</strong> {acc.bankName}</div>}
    {acc.accountNumber && <div><strong>شماره حساب:</strong> {acc.accountNumber}</div>}
  </div>
)}
