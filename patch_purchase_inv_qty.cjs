const fs = require('fs');
let code = fs.readFileSync('src/components/invoices/PurchaseInvoiceCreate.tsx', 'utf8');
...
fs.writeFileSync('src/components/invoices/PurchaseInvoiceCreate.tsx', code);
console.log('patched PurchaseInvoiceCreate');
